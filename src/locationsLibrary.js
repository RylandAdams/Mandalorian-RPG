export default function Locations (id, description) {
  ...
  let hideoutLargeChamber = new Locations("Large Chamber", "Taking a glance around its hard to say with any certainty this chamber is empty. There are too many possible hidding spots.");
